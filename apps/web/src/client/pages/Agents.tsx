...
export function AgentsPage() {
  ...
  return <div className="page">
    <PageHeader eyebrow="AGENT FLEET" title="Production agents" description="Discover health, telemetry readiness, runs, and tools for every connected agent." actions={<Button onClick={() => setRegisterOpen(true)}><Plus size={16} />Register agent</Button>} />
